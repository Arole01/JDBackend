exports.signUpTemplate=(otp,firstName)=>{
    ...
    <head>
        ...
        <title>Welcome to Jersey Dynasty </title>
        <style>
            body {
            ...
            .button {
                ...
                background-color: #9803fc; /* Green background */
                color: #ffffff;
                padding: 15px 30px;
                font-size: 18px;
    ...
    <body>
        <div class="container">
            <div class="header">
                <h1>Welcome Jersey Dynasty</h1>
            </div>
            <div class="content">
                <p>Hello ${firstName},</p>
                <p>Welcome to Jersey Dynasty — we’re so glad you’re here! To get started and secure your account, please use the One-Time Password (OTP).</p>
    ...
    <body>
        <div class="container">
            ...
            <div class="button">
                ...
                <p>Best regards,<br>Jersey Dynasty</p>
            </div>
            <div class="footer">
                <p>&copy; ${new Date().getFullYear()} . All rights reserved.</p>
            </div>  
